...
class StableDiffusion(nn.Module):
    ...
    def real_image_ldm_stable(
        ...
        #img_path = "66.png"
        img_path = "New folder/image/48.jpg"
        #img_path = "/home/v-siyuanyang/coco/val2017/000000006723.jpg"
        ...
        for i, t in enumerate(self.scheduler.timesteps):
            ...
            if t > guidance_step:
                plus_guidance = True 
                self.save_attention.self_attn = False# True
            ...
            def forward(x, encoder_hidden_states=None, attention_mask=None):
                ...
                if is_cross==False:
                    if save_attention.self_attn==True:
                        if place_in_unet == 'up':
                            #if save_attention.place_in_cross in [0,1,2,3,4]:
    ...
    def guidance(self, t, latents, latents_ori):
        ...
        return loss,  grad_mask * mask.squeeze(0)  * 1 #* mask
...
if __name__=='__main__':
    ...
    sd = StableDiffusion(device, fp16=False, vram_O=False, sd_version='2.1',object_id_d=[[6]], object_id_s=[8])
    ...
    prompts = ["A real photo of a bubble ."] #["A photo of a woman"]
    ...
    images, x_t = sd.real_image_ldm_stable(prompts, latent=None, num_inference_steps=50, guidance_scale=7.5, generator=None, low_resource=False,  guidance_step=11, t_ratio=0.6)
