...
class StableDiffusion(nn.Module):
    ...
    def guidance(self, t):
        ...
        target_cen=torch.tensor([20,10],device=attn_edit.device)
        ...
        #loss += self.l1_loss(edit_size,ori_size)  * 1
    ...
    def rev_step(self, model_output: Union[torch.FloatTensor, np.ndarray], timestep: int, sample: Union[torch.FloatTensor, np.ndarray]):
...
if __name__=='__main__':
    ...
    images, x_t = sd.text2image_ldm_stable(prompts, latent=None, num_inference_steps=100, guidance_scale=7.5, generator=None, low_resource=False,  guidance_step=101)
