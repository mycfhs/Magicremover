    ...
    def drag_diffusion(self, img, point, prompts, negative_prompts='', height=512, width=512, num_inference_steps=50, guidance_scale=7.5):
        ...
        while(torch.norm((p_t-p_c).type(torch.float))>3):
            ...
            with torch.enable_grad():
                ...
                # x_t_512 =  F.interpolate(x_t, size=(512, 512), mode='bilinear', align_corners=False)
                # x_t_512 = x_t_512 * (1-mask) +  x_t_512_ori *  mask
                # x_t_tmp = F.interpolate(x_t_512, size=(64,64), mode='bilinear', align_corners=False)    
