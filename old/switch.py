...
class StableDiffusion(nn.Module):
    ...
    def real_image_ldm_stable(
        ...
        new_text_embeddings = self.text_encoder(text_input.input_ids.to(self.device))[0]
        ...
        #img_path = "8.jpg"
        img_path = "dreambooth/dataset/dog3/01.jpg"
        ...
        for i, t in enumerate(self.scheduler.timesteps):
            ...
            context = torch.cat([uncond_embeds_list[i], new_text_embeddings])
            self.save_attention.state = "edit"
            if t > guidance_step:
                plus_guidance = False #True 
                self.save_attention.self_attn = True
    ...
    def register_attention_control(self):
        ...
        def ca_forward(self, place_in_unet):
            ...
            def forward(x, encoder_hidden_states=None, attention_mask=None):
                ...
                #         #if place_in_unet == 'down' and save_attention.place_in_cross in [0,1,2,3,4,5]:        # down 6 mid 1 up 9
    ...
    def diffusion_step(self, latents, context, t, guidance_scale,  low_resource=False, plus_guidance=False, remain_step=False, latents_ori=None):
        ...
        if plus_guidance:
            ...
            with torch.enable_grad():
                ...
                torchvision.utils.save_image(torch.concat((normalize(attn_edit_thresh).unsqueeze(0),normalize(gradients.sum(1)), normalize(gradients.sum(1)) *  attn_edit_thresh),dim=2),f'attn_thresh/{t}.png')
...
if __name__=='__main__':
    ...
    images, x_t = sd.real_image_ldm_stable(prompts, latent=None, num_inference_steps=50, guidance_scale=7.5, generator=None, low_resource=False,  guidance_step=11, t_ratio=0.4)
